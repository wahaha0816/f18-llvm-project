...
subroutine array_substring_embox(arr)
  ...
  ! CHECK: %[[VAL_9:.*]] = arith.constant 5 : i64
  ! CHECK: %[[VAL_10:.*]] = arith.constant 7 : i64
  ! CHECK: %[[VAL_11:.*]] = arith.constant 1 : i64
  ! CHECK: %[[VAL_12:.*]] = arith.subi %[[VAL_9]], %[[VAL_11]] : i64
  ! CHECK: %[[VAL_13:.*]] = arith.constant 0 : i64
  ! CHECK: %[[VAL_14:.*]] = arith.subi %[[VAL_10]], %[[VAL_12]] : i64
  ! CHECK: %[[VAL_15:.*]] = arith.cmpi sgt, %[[VAL_14]], %[[VAL_13]] : i64
