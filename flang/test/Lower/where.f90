  ...
  ! CHECK: %[[VAL_8:.*]] = constant 4.000000e+00 : f32
  ...
  ! CHECK: %[[VAL_51:.*]] = constant 1.000000e+02 : f32
  ...
  ! CHECK: %[[VAL_57:.*]] = subi %[[VAL_48]], %[[VAL_55]] : index
  ...
  ! CHECK: %[[VAL_69:.*]] = constant 10 : i64
  ! CHECK: %[[VAL_70:.*]] = fir.convert %[[VAL_69]] : (i64) -> index
  ! CHECK: %[[VAL_71:.*]] = constant 2.000000e+00 : f32
  ...
  ! CHECK: %[[VAL_74:.*]] = constant 1 : index
  ! CHECK: %[[VAL_75:.*]] = constant 0 : index
  ! CHECK: %[[VAL_76:.*]] = subi %[[VAL_70]], %[[VAL_74]] : index
  ...
  ! CHECK: %[[VAL_81:.*]] = addi %[[VAL_78]], %[[VAL_80]] : index
  ...
  ! CHECK: %[[VAL_87:.*]] = mulf %[[VAL_71]], %[[VAL_86]] : f32
  ...
  ! CHECK: %[[VAL_95:.*]] = constant 5.000000e+01 : f32
  ...
  ! CHECK: %[[VAL_101:.*]] = subi %[[VAL_92]], %[[VAL_99]] : index
  ...
  ! CHECK: %[[VAL_113:.*]] = constant 10 : i64
  ! CHECK: %[[VAL_114:.*]] = fir.convert %[[VAL_113]] : (i64) -> index
  ! CHECK: %[[VAL_115:.*]] = constant 3.000000e+00 : f32
  ...
  ! CHECK: %[[VAL_118:.*]] = constant 1 : index
  ! CHECK: %[[VAL_119:.*]] = constant 0 : index
  ! CHECK: %[[VAL_120:.*]] = subi %[[VAL_114]], %[[VAL_118]] : index
  ...
  ! CHECK: %[[VAL_125:.*]] = addi %[[VAL_122]], %[[VAL_124]] : index
  ...
  ! CHECK: } else {
  ! CHECK: %[[VAL_130:.*]] = constant 1 : index
  ! CHECK: %[[VAL_131:.*]] = addi %[[VAL_122]], %[[VAL_130]] : index
  ...
  ! CHECK: %[[VAL_137:.*]] = addf %[[VAL_115]], %[[VAL_136]] : f32
  ...
  ! CHECK: %[[VAL_148:.*]] = constant 1.000000e+00 : f32
  ! CHECK: %[[VAL_149:.*]] = constant 1 : index
  ! CHECK: %[[VAL_150:.*]] = constant 0 : index
  ! CHECK: %[[VAL_151:.*]] = subi %[[VAL_145]], %[[VAL_149]] : index
  ...
  ! CHECK: %[[VAL_156:.*]] = addi %[[VAL_153]], %[[VAL_155]] : index
  ...
  ! CHECK: } else {
  ! CHECK: %[[VAL_161:.*]] = constant 1 : index
  ! CHECK: %[[VAL_162:.*]] = addi %[[VAL_153]], %[[VAL_161]] : index
  ...
  ! CHECK: %[[VAL_179:.*]] = constant 2.000000e+00 : f32
  ! CHECK: %[[VAL_180:.*]] = constant 1 : index
  ! CHECK: %[[VAL_181:.*]] = constant 0 : index
  ! CHECK: %[[VAL_182:.*]] = subi %[[VAL_176]], %[[VAL_180]] : index
  ! CHECK: %[[VAL_183:.*]] = fir.do_loop %[[VAL_184:.*]] = %[[VAL_181]] to %[[VAL_182]] step %[[VAL_180]] unordered iter_args(%[[VAL_185:.*]] = %[[VAL_174]]) -> (!fir.array<10xf32>) {
  ! CHECK: %[[VAL_186:.*]] = constant 1 : index
  ! CHECK: %[[VAL_187:.*]] = addi %[[VAL_184]], %[[VAL_186]] : index
  ...
  ! CHECK: %[[VAL_193:.*]] = addi %[[VAL_184]], %[[VAL_192]] : index
