...
! CHECK:   %[[VAL_10:.*]] = cmpi sgt, %[[VAL_9]], %[[VAL_2]] : index
...
! CHECK:   %[[VAL_23:.*]] = subi %[[VAL_9]], %[[VAL_3]] : index
...
! CHECK:   %[[VAL_45:.*]] = subi %[[VAL_36]], %[[VAL_27]] : index
...
! CHECK:   %[[VAL_52:.*]] = cmpi sgt, %[[VAL_51]], %[[VAL_47]] : index
! CHECK:   cond_br %[[VAL_52]], ^bb2, ^bb3
! CHECK: ^bb2:
! CHECK:   %[[VAL_53:.*]] = addi %[[VAL_50]], %[[VAL_48]] : index
...
! CHECK:   %[[VAL_66:.*]] = subi %[[VAL_51]], %[[VAL_48]] : index
...
! CHECK:   %[[VAL_86:.*]] = cmpi sgt, %[[VAL_85]], %[[VAL_70]] : index
...
! CHECK:   %[[VAL_89:.*]] = addi %[[VAL_84]], %[[VAL_71]] : index
...
! CHECK:   %[[VAL_94:.*]] = subi %[[VAL_85]], %[[VAL_71]] : index
...
! CHECK:   %[[VAL_108:.*]] = cmpi sgt, %[[VAL_107]], %[[VAL_98]] : index
...
! CHECK:   %[[VAL_111:.*]] = addi %[[VAL_106]], %[[VAL_99]] : index
...
! CHECK:   %[[VAL_117:.*]] = subi %[[VAL_107]], %[[VAL_99]] : index
