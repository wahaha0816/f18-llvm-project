...
subroutine trans_test(store, word)
  ...
  ! CHECK:         %[[VAL_7:.*]] = fir.address_of(@_QQcl.{{.*}}) : !fir.ref<!fir.char<1,90>>
  ! CHECK:         %[[VAL_8:.*]] = constant {{.*}} : i32
  ...
  ! CHECK:         %[[VAL_12:.*]] = fir.convert %[[VAL_7]] : (!fir.ref<!fir.char<1,90>>) -> !fir.ref<i8>
...
subroutine trans_test2(store, word)
  ...
  ! CHECK:         %[[VAL_6:.*]] = constant 3 : i64
  ! CHECK:         %[[VAL_7:.*]] = fir.convert %[[VAL_6]] : (i64) -> index
  ! CHECK:         %[[VAL_8:.*]] = constant 3 : i32
  ...
  ! CHECK:         %[[VAL_16:.*]] = fir.address_of(@_QQcl.{{.*}}) : !fir.ref<!fir.char<1,90>>
  ! CHECK:         %[[VAL_17:.*]] = constant {{.*}} : i32
  ...
  ! CHECK:         %[[VAL_21:.*]] = fir.convert %[[VAL_16]] : (!fir.ref<!fir.char<1,90>>) -> !fir.ref<i8>
  ...
  ! CHECK:         %[[VAL_32:.*]] = subi %[[VAL_7]], %[[VAL_30]] : index
...
integer function trans_test3(p)
  ...
  ! CHECK:         %[[VAL_9:.*]] = fir.address_of(@_QQcl.{{.*}}) : !fir.ref<!fir.char<1,90>>
  ! CHECK:         %[[VAL_10:.*]] = constant {{.*}} : i32
  ...
  ! CHECK:         %[[VAL_14:.*]] = fir.convert %[[VAL_9]] : (!fir.ref<!fir.char<1,90>>) -> !fir.ref<i8>
  ...
  ! CHECK:         %[[VAL_19:.*]] = fir.address_of(@_QQcl.{{.*}}) : !fir.ref<!fir.char<1,90>>
  ! CHECK:         %[[VAL_20:.*]] = constant {{.*}} : i32
  ...
  ! CHECK:         %[[VAL_23:.*]] = fir.convert %[[VAL_19]] : (!fir.ref<!fir.char<1,90>>) -> !fir.ref<i8>
