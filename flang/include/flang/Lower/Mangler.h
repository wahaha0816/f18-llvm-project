...
std::string
mangleArrayLitteral(const uint8_t *addr, size_t size,
...
template <int KIND>
std::string
mangleArrayLitteral(const Fortran::evaluate::Constant<Fortran::evaluate::Type<
...
inline std::string mangleArrayLitteral(
