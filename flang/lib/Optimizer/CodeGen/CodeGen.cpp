...
struct FieldIndexOpConversion : public FIROpConversion<fir::FieldIndexOp> {
  ...
  matchAndRewrite(fir::FieldIndexOp field, OperandTy operands,
                  mlir::ConversionPatternRewriter &rewriter) const override {
    // Assuming derive type have a compile time constant layout.
    // Field -> index of the component type in the parent type (to be used in
    // GEP).
...
struct FIRToLLVMLoweringPass
  ...
  void runOnOperation() override final {
    ...
    pattern.insert<
        ...
        CmpfOpConversion, ConstcOpConversion, ConstfOpConversion,
