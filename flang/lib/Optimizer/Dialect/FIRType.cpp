...
mlir::LogicalResult fir::BoxType::verifyConstructionInvariants(mlir::Location,
    mlir::Type, mlir::AffineMapAttr) {
  // TODO
  return mlir::success();
}
...
mlir::LogicalResult
fir::RealType::verifyConstructionInvariants(mlir::Location, KindTy fKind) {
  // TODO
  return mlir::success();
}
...
mlir::LogicalResult
fir::SequenceType::verifyConstructionInvariants(mlir::Location loc,
